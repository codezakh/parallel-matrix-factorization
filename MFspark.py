...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(description = 'Parallel Matrix Factorization.',formatter_class=argparse.ArgumentDefaultsHelpFormatter)
